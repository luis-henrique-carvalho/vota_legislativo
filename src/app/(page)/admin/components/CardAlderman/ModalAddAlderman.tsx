...
type Props = {
  handleAddAalderman: (newAlderman: User) => void;
};
...
export default function ModalAddAlderman({ handleAddAalderman }: Props) {
  ...
  const handleSubmitUser = async (values: any) => {
    try {
      const newAlderman: User = await createUser(values);
      handleAddAalderman(newAlderman);
    } catch (error: any) {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} placement="top-center">
        <ModalContent>
          <ModalHeader className="flex flex-col">Adicionar Usuário</ModalHeader>
          <ModalBody>
            <form
            ...
            >
              ...
              <Input
                ...
                errorMessage={touched.data_nascimento && errors.data_nascimento}
              />
              <Input
                label="RG"
                className="w-6/12"
              ...
              <Input
                ...
                errorMessage={touched.titulo_eleitor && errors.titulo_eleitor}
              />
              <Input
